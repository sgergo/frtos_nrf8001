...
typedef struct aci_state_t
{
  ...
  bool                          bonded;                                 /* Is the nRF8001 bonded to a peer device */
  ...
  /* Variables that are valid only when in a connection */
 ...
 *  - ACI_TEST_MODE_DTM_UART: DTM commands are received over UART.
 *  - ACI_TEST_MODE_DTM_ACI : DTM commands are received over ACI.
