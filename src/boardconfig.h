...
#define BLE_RST_PINPERIPHERIAL				SYSCTL_PERIPH_GPIOF
#define BLE_REQN_PINPERIPHERIAL				SYSCTL_PERIPH_GPIOF
#define BLE_RDYN_PINPERIPHERIAL				SYSCTL_PERIPH_GPIOF

#define BLE_RST_PORTBASE					GPIO_PORTF_BASE
#define BLE_REQN_PORTBASE					GPIO_PORTF_BASE
#define BLE_RDYN_PORTBASE					GPIO_PORTF_BASE

#define BLE_RST_PIN 						GPIO_PIN_1
#define BLE_REQN_PIN 						GPIO_PIN_2
#define BLE_RDYN_PIN 						GPIO_PIN_3

#define BLE_RDYN_PORT_INT					INT_GPIOB
#define BLE_RDYN_PIN_INT					GPIO_INT_PIN_1
